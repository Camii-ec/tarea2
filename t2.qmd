...
colnames(tabla_datos6) <- c("Lasso","Ridge","Lasso Adaptivo", "Elastic-Net","Mínimo Cuadrado Ordinarios")
...
El método que genera el mejor errror de predicción, sería aquel que tenga menor MSE, pues es el que menos se equivoca al momento de predecir. El método de Ridge sería el ideal en este caso, ya que su error es cercano al $42\%$. Es claro, de la tabla anterior que en general el MSE, no se aleja mucho pero es mejor el método Ridge.
