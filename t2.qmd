...
Guiándonos de la última pregunta, el mejor método sería el de Ridge, por las justificaciones dichas anteriormente por su valor de MSE.
...
Los gráficos anterioriormente presentados, muestran de manera resumida los valores de los predictores y de aquí es bastante claro ver que los métodos eligen casi el mismo subconjunto de variables
